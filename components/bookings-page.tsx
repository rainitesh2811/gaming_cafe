...
import { CalendarDays, ChevronLeft, Clock3, MapPin, Ticket } from 'lucide-react'
...
export function BookingsPage() {
  ...
  return <main className="bookings-shell">
    ...
    <nav className="bottom-nav" aria-label="Main navigation"><Link href="/"><span>Home</span></Link><Link className="active" href="/bookings"><Ticket size={20} /><span>Bookings</span></Link></nav>
  </main>
}
